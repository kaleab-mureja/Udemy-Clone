        ...
        <div className="col-lg-8 offset-lg-2">
          <div className="card shadow">
            <div className="card-body">
              ...
              <p>
                Your privacy is important to us. It is Udemy Learning's policy
                to respect your privacy regarding any information we may collect
                from you across our website,{" "}
                <a href="#">https://www.udemylearning.com</a>, and other sites
                we own and operate.
              </p>
              <p>
              ...
              <p>This policy is effective as of 19 May 2024.</p>
            </div>
          </div>
        </div>
      </div>
